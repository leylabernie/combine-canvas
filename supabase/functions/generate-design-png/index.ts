...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = `Create a beautiful, high-quality product design with a transparent background. 
Design inspiration: ${inspirations || "modern and elegant"}
Product type: ${productTypes || "decorative item"}
Color scheme: ${colorSchemes || "vibrant and appealing"}
Design style: ${designConcepts || "clean and professional"}

The design should be centered, professional, and suitable for print-on-demand products. Make it visually striking and commercially appealing. Ultra high resolution.`;
